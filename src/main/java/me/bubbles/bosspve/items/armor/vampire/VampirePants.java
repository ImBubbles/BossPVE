...
public class VampirePants extends Armor {

    public VampirePants(BossPVE plugin) {
        super(plugin, Material.LEATHER_LEGGINGS, "vampirePants");
    ...
    public HashSet<Flag<me.bubbles.bosspve.flags.ItemFlag, Double>> getFlags() {
        ...
        result.add(new Flag<me.bubbles.bosspve.flags.ItemFlag, Double>(me.bubbles.bosspve.flags.ItemFlag.PROT_ADD, 7D, false));
