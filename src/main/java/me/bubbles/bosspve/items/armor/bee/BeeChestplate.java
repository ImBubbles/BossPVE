...
public class BeeChestplate extends Armor {
    ...
    public BeeChestplate() {
        super(Material.LEATHER_CHESTPLATE, "beeChestplate");
    ...
    public HashSet<Flag<me.bubbles.bosspve.flags.ItemFlag, Double>> getFlags() {
        ...
        result.add(new Flag<me.bubbles.bosspve.flags.ItemFlag, Double>(me.bubbles.bosspve.flags.ItemFlag.HEALTH_ADD, 8D, false));
        result.add(new Flag<me.bubbles.bosspve.flags.ItemFlag, Double>(me.bubbles.bosspve.flags.ItemFlag.PROT_ADD, 4D, false));
        result.add(new Flag<me.bubbles.bosspve.flags.ItemFlag, Double>(me.bubbles.bosspve.flags.ItemFlag.DAMAGE_ADD, 6D, false));
        return result;
    }

    @Override
    public String getDescription() {
        return "Chestplate from a Bee";
    }
